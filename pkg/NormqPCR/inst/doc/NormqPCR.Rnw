...
data(Bladder)
res.Bladder <- stabMeasureRho(Bladder[,3:16], group = Bladder$Grade, 
                              log = FALSE)
sort(res.Bladder)
@
...
of And04.
<<NormFinder1>>=
selectHKs(Colon[,3:15], log = FALSE, trace = FALSE, 
          Symbols = names(Colon)[3:15])$ranking
selectHKs(Bladder[,3:16], log = FALSE, trace = FALSE, 
          Symbols = names(Bladder)[3:16])$ranking
@
...
<<NormFinder2>>=
selectHKs(Colon[,3:15], group = Colon$Classification, 
          log = FALSE, trace = TRUE, 
          Symbols = names(Colon)[3:15], minNrHKs = 12,
          method = "NormFinder")$ranking
selectHKs(Bladder[,3:16], group = Bladder$Grade, 
          log = FALSE, trace = FALSE, 
          Symbols = names(Bladder)[3:16], minNrHKs = 13,
          method = "NormFinder")$ranking
@
%-------------------------------------------------------------------------------
