plotVsHkg = function(qPCRSet, saveToFile=FALSE)
{
    nset <- qPCRSet@nSet # this refers to the actual data
    hkgs <- qPCRSet@hkgs # these are the housekeeping genes the data has been normalised to
